...
let gameOptions = {
  ...
  // spawn range, how far should the rightmost platform be from the right edge before next platform spawns, in pixels
  spawnRange: [80, 300],
...
class playGame extends Phaser.Scene {
  ...
  // the player jumps when on the ground, or once in the air as long as there are jumps left and the first jump was on the ground and obviously if the player is not dying
  jump() {
    if((!this.dying) &amp &amp  (this.player.body.touching.down || (this.playerJumps > 0 &amp &amp  this.playerJumps < gameOptions.jumps))) {
