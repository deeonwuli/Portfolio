(function ($) {
  ...
  if (settings.scrollWheel.enabled) {
    ...
    // github.com/facebook/fixed-data-table/blob/master/src/vendor_upstream/dom/normalizeWheel.js
      ...
      // Disable on <=small.
        ...
        var delta = Math.min(Math.abs(x), 150) * settings.scrollWheel.factor
  ...
  if (settings.scrollZones.enabled) {
    (function () {
      ...
      var $right = $('<div class="scrollZone right"></div>')

      var $zones = $left.add($right)
  ...
  if (settings.dragging.enabled) {
    (function () {
      ...
      var momentumIntervalId; var velocityIntervalId

      var startX; var currentX; var previousX

      var velocity; var direction
